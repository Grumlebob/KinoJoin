...
public class Cinemas
{
    ...
    public List<CinemaOption> Options { get; set; }
}
...
{
    [JsonProperty("sort")]
    public object Sort { get; set; } // Replace object with specific type if necessary

    [JsonProperty("city")]
    public object City { get; set; } // Replace object with specific type if necessary
    ...
    [JsonProperty("date")]
    public object Date { get; set; } // Replace object with specific type if necessary
}
...
{
    [JsonProperty("options")]
    public List<MovieOptions> Options { get; set; }
}
